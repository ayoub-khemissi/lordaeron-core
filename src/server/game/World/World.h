...
enum WorldBoolConfigs : uint32
{
    ...
    CONFIG_INSTANCE_HEROIC_LOCK,
    CONFIG_INSTANCE_RAID_LOCK,
    CONFIG_CAST_UNSTUCK,
    ...
    CONFIG_AUTO_LEARN_TRAINER_SPELLS,
...
enum WorldIntConfigs : uint32
{
    ...
    CONFIG_INSTANCE_HEROIC_RESET_HOUR,
    CONFIG_INSTANCE_RAID_RESET_DAYS,
    CONFIG_INSTANCE_RAID_RESET_HOUR,
